    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          v-for="a in author"
          :key="a.id"
          :class="{ highlight: isOrwell(a) }"
          :style="isOrwell(a) ? { fontWeight: 'bold', color: '#fff' } : {}"
          :title="isOrwell(a) ? 'Featured author' : ''"
        >
          {{ a.name }} ({{ a.birthYear }})
        </li>
      </ul>
      ...
      <!-- TODO: CODE TO RENDER LIST
       
              OF AUSTEN'S WORKS HERE -->
    </section>
